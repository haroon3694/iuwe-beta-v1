            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-6'>
                <div className="flex justify-center items-center">
                    <div className={`w-full bg-[color:var(--primary-color)] h-full flex justify-start items-center rounded-[15px] p-10`}>
                        <h1 className={`text-white text-4xl font-[600] font-montserat`}>About Us</h1>
                    </div>
                </div>
                <div className='w-full col-start-1 md:row-start-2 bg-[color:var(--secondary-color)] rounded-[15px] p-10'>
                    <p className='font-[500]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                </div>
